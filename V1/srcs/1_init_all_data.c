...
/*   Updated: 2022/12/29 18:35:17 by yokitaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_map_data(t_map_data *map_data)
{
    ...
    map_data->height = 0;
    map_data->width = 0;
    map_data->player_position_line = 0;
    map_data->player_position_column = 0;
...
void init_player_data(t_player_data *player_data)
{
    ...
    player_data->position_line = 0;
    player_data->position_column = 0;
}
