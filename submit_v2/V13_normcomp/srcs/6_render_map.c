...
/*   Updated: 2023/01/18 01:42:00 by yokitaga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	//https://harm-smits.github.io/42docs/libs/minilibx/prototypes.html#mlx_put_image_to_window
	//指定されたウィンドウ インスタンスの位置 (x,y) に画像を配置
